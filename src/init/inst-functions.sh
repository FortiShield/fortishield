...
# Fortishield Installer Functions
    ...
    if [ "$CONFIGURATION_ASSESSMENT_FILES_PATH" = "ERROR_NOT_FOUND" ]; then
        ...
        for FILE in $CONFIGURATION_ASSESSMENT_FILES; do
            if [ -f "../ruleset/sca/$FILE" ]; then
                ${INSTALL} -m 0640 -o root -g ${FORTISHIELD_GROUP} ../ruleset/sca/$FILE ${INSTALLDIR}/ruleset/sca
            else
...
GenerateService()
{
    ...
    sed "s|FORTISHIELD_HOME_TMP|${INSTALLDIR}|g" ${SERVICE_TEMPLATE}
}
...
WriteManager()
{
    ...
    if [ "$EMAILNOTIFY" = "yes"   ]; then
        ...
        s|<smtp_server>smtp.example.fortishield.khulnasoft.com</smtp_server>|<smtp_server>${SMTP}</smtp_server>|g; \
        s|<email_from>fortishield@example.fortishield.khulnasoft.com</email_from>|<email_from>fortishield@${HOST}</email_from>|g; \
        s|<email_to>recipient@example.fortishield.khulnasoft.com</email_to>|<email_to>${EMAIL}</email_to>|g;" "${GLOBAL_TEMPLATE}" >> $NEWCONFIG
    else
...
InstallCommon()
{
    ...
    ./init/adduser.sh ${FORTISHIELD_USER} ${FORTISHIELD_GROUP} ${INSTALLDIR}
  ...
  ${INSTALL} -m 0660 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} /dev/null ${INSTALLDIR}/logs/active-responses.log
    ...
    if [ ${INSTYPE} = 'agent' ]; then
        ...
        ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/bin
    fi

  ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/lib
    ...
    then
        ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} shared_modules/dbsync/build/lib/libdbsync.so ${INSTALLDIR}/lib
    ...
    then
        ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} shared_modules/rsync/build/lib/librsync.so ${INSTALLDIR}/lib
    ...
    then
        ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} data_provider/build/lib/libsysinfo.so ${INSTALLDIR}/lib
    ...
    then
        ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} syscheckd/build/lib/libfimdb.so ${INSTALLDIR}/lib
    ...
    then
        if [ -f libstdc++.a ]
        then
            ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} libstdc++.a ${INSTALLDIR}/lib
        fi

        if [ -f libgcc_s.a ]
        then
            ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} libgcc_s.a ${INSTALLDIR}/lib
        fi
    else
        if [ -f libstdc++.so.6 ]
        then
            ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} libstdc++.so.6 ${INSTALLDIR}/lib
        ...
        if [ -f libgcc_s.so.1 ]
        then
            ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} libgcc_s.so.1 ${INSTALLDIR}/lib
  ...
  ${INSTALL} -d -m 0770 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/sockets
  ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/diff
  ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/fim
  ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/fim/db
  ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/syscollector
  ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/syscollector/db
  ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/logcollector

  ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/ruleset
  ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/ruleset/sca

  ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles
  ${INSTALL} -d -m 0770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/var/wodles

  ${INSTALL} -d -m 0770 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/etc

    if [ -f /etc/localtime ]
    then
         ${INSTALL} -m 0640 -o root -g ${FORTISHIELD_GROUP} /etc/localtime ${INSTALLDIR}/etc
    fi

  ${INSTALL} -d -m 1770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/tmp

    if [ -f /etc/TIMEZONE ]; then
         ${INSTALL} -m 0640 -o root -g ${FORTISHIELD_GROUP} /etc/TIMEZONE ${INSTALLDIR}/etc/
    fi
    # Solaris Needs some extra files
    if [ ${DIST_NAME} = "SunOS" ]; then
      ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/usr/share/lib/zoneinfo/
        cp -rf /usr/share/lib/zoneinfo/* ${INSTALLDIR}/usr/share/lib/zoneinfo/
        chown root:${FORTISHIELD_GROUP} ${INSTALLDIR}/usr/share/lib/zoneinfo/*
    ...
    if [ ! -f ${INSTALLDIR}/etc/ossec.conf ]; then
        if [ -f  ../etc/ossec.mc ]; then
            ${INSTALL} -m 0660 -o root -g ${FORTISHIELD_GROUP} ../etc/ossec.mc ${INSTALLDIR}/etc/ossec.conf
        else
            ...
            ${INSTALL} -m 0660 -o root -g ${FORTISHIELD_GROUP} ${OSSEC_CONF_SRC} ${INSTALLDIR}/etc/ossec.conf
        fi
    fi

  ${INSTALL} -d -m 0770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/etc/shared
  ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/active-response
  ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/active-response/bin
  ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/agentless
  ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} agentlessd/scripts/* ${INSTALLDIR}/agentless/

  ${INSTALL} -d -m 0770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/.ssh

  ./init/fw-check.sh execute
  ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} active-response/*.sh ${INSTALLDIR}/active-response/bin/
  ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} active-response/*.py ${INSTALLDIR}/active-response/bin/
  ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} firewall-drop ${INSTALLDIR}/active-response/bin/
  ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} default-firewall-drop ${INSTALLDIR}/active-response/bin/
  ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} pf ${INSTALLDIR}/active-response/bin/
  ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} npf ${INSTALLDIR}/active-response/bin/
  ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ipfw ${INSTALLDIR}/active-response/bin/
  ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} firewalld-drop ${INSTALLDIR}/active-response/bin/
  ...
  ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/backup
...
InstallLocal()
{
    ...
    ${INSTALL} -d -m 0770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/etc/decoders
    ${INSTALL} -d -m 0770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/etc/rules
    ${INSTALL} -d -m 0770 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/var/multigroups
    ${INSTALL} -d -m 0770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/var/db
    ${INSTALL} -d -m 0770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/var/download
    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/logs/archives
    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/logs/alerts
    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/logs/firewall
    ...
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/ruleset/rules

    ${INSTALL} -m 0640 -o root -g ${FORTISHIELD_GROUP} -b ../ruleset/rules/*.xml ${INSTALLDIR}/ruleset/rules
    ${INSTALL} -m 0640 -o root -g ${FORTISHIELD_GROUP} -b ../ruleset/decoders/*.xml ${INSTALLDIR}/ruleset/decoders
    ${INSTALL} -m 0660 -o root -g ${FORTISHIELD_GROUP} ../ruleset/rootcheck/db/*.txt ${INSTALLDIR}/etc/rootcheck

    InstallSecurityConfigurationAssessmentFiles "manager"

    if [ ! -f ${INSTALLDIR}/etc/decoders/local_decoder.xml ]; then
        ${INSTALL} -m 0660 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} -b ../etc/local_decoder.xml ${INSTALLDIR}/etc/decoders/local_decoder.xml
    fi
    if [ ! -f ${INSTALLDIR}/etc/rules/local_rules.xml ]; then
        ${INSTALL} -m 0660 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} -b ../etc/local_rules.xml ${INSTALLDIR}/etc/rules/local_rules.xml
    fi
    if [ ! -f ${INSTALLDIR}/etc/lists ]; then
        ${INSTALL} -d -m 0770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/etc/lists
    fi
    if [ ! -f ${INSTALLDIR}/etc/lists/amazon ]; then
        ${INSTALL} -d -m 0770 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/etc/lists/amazon
        ${INSTALL} -m 0660 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} -b ../ruleset/lists/amazon/* ${INSTALLDIR}/etc/lists/amazon/
    fi
    if [ ! -f ${INSTALLDIR}/etc/lists/audit-keys ]; then
        ${INSTALL} -m 0660 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} -b ../ruleset/lists/audit-keys ${INSTALLDIR}/etc/lists/audit-keys
    fi
    if [ ! -f ${INSTALLDIR}/etc/lists/security-eventchannel ]; then
        ${INSTALL} -m 0660 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} -b ../ruleset/lists/security-eventchannel ${INSTALLDIR}/etc/lists/security-eventchannel
    fi

    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/fts
    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/agentless
    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/db

    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/integrations
    ${INSTALL} -m 750 -o root -g ${FORTISHIELD_GROUP} ../integrations/pagerduty.py ${INSTALLDIR}/integrations/pagerduty.py
    ${INSTALL} -m 750 -o root -g ${FORTISHIELD_GROUP} ../integrations/slack.py ${INSTALLDIR}/integrations/slack.py
    ${INSTALL} -m 750 -o root -g ${FORTISHIELD_GROUP} ../integrations/virustotal.py ${INSTALLDIR}/integrations/virustotal.py
    ${INSTALL} -m 750 -o root -g ${FORTISHIELD_GROUP} ../integrations/shuffle.py ${INSTALLDIR}/integrations/shuffle.py
    ${INSTALL} -m 750 -o root -g ${FORTISHIELD_GROUP} ../integrations/maltiverse.py ${INSTALLDIR}/integrations/maltiverse.py
    touch ${INSTALLDIR}/logs/integrations.log
    chmod 640 ${INSTALLDIR}/logs/integrations.log
    chown ${FORTISHIELD_USER}:${FORTISHIELD_GROUP} ${INSTALLDIR}/logs/integrations.log
    ...
    ${INSTALL} -d -m 0660 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/vd
    ${INSTALL} -d -m 0660 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/indexer

    # Install templates files
    ${INSTALL} -d -m 0440 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/templates
    ${INSTALL} -m 0440 -o root -g ${FORTISHIELD_GROUP} fortishield_modules/vulnerability_scanner/indexer/template/legacy-template.json ${INSTALLDIR}/templates/vd_states_template.json
...
checkDownloadContent()
{
    ...
    if [ "X${DOWNLOAD_CONTENT}" = "Xy" ]; then
        ...
        chown ${FORTISHIELD_USER}:${FORTISHIELD_GROUP} ${VD_FULL_PATH}
    fi
}
...
InstallServer()
{
    ...
    then
        ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} external/jemalloc/lib/libjemalloc.so.2 ${INSTALLDIR}/lib
    ...
    then
        ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} build/shared_modules/router/librouter.so ${INSTALLDIR}/lib
    ...
    then
        ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} build/shared_modules/content_manager/libcontent_manager.so ${INSTALLDIR}/lib
    ...
    then
        ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} build/shared_modules/indexer_connector/libindexer_connector.so ${INSTALLDIR}/lib
    ...
    then
        ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} external/rocksdb/build/librocksdb.so.8 ${INSTALLDIR}/lib
    ...
    ${INSTALL} -d -m 0770 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/cluster
    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/logs/cluster

    ${INSTALL} -d -m 0770 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/etc/shared/default
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/backup/shared
    ...
    if [ ! -f ${INSTALLDIR}/queue/agents-timestamp ]; then
        ${INSTALL} -m 0600 -o root -g ${FORTISHIELD_GROUP} /dev/null ${INSTALLDIR}/queue/agents-timestamp
    fi

    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/backup/agents
    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/backup/db

    ${INSTALL} -m 0660 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ../ruleset/rootcheck/db/*.txt ${INSTALLDIR}/etc/shared/default

    if [ ! -f ${INSTALLDIR}/etc/shared/default/agent.conf ]; then
        ${INSTALL} -m 0660 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ../etc/agent.conf ${INSTALLDIR}/etc/shared/default
    fi

    if [ ! -f ${INSTALLDIR}/etc/shared/agent-template.conf ]; then
        ${INSTALL} -m 0660 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ../etc/agent.conf ${INSTALLDIR}/etc/shared/agent-template.conf
    fi

    # Install the plugins files
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/__init__.py ${INSTALLDIR}/wodles/__init__.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/utils.py ${INSTALLDIR}/wodles/utils.py

    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/aws
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/aws/buckets_s3
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/aws/services
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/aws/subscribers
    ...
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/buckets_s3/guardduty.py ${INSTALLDIR}/wodles/aws/buckets_s3/guardduty.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/buckets_s3/__init__.py ${INSTALLDIR}/wodles/aws/buckets_s3/__init__.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/buckets_s3/load_balancers.py ${INSTALLDIR}/wodles/aws/buckets_s3/load_balancers.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/buckets_s3/server_access.py ${INSTALLDIR}/wodles/aws/buckets_s3/server_access.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/buckets_s3/umbrella.py ${INSTALLDIR}/wodles/aws/buckets_s3/umbrella.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/buckets_s3/vpcflow.py ${INSTALLDIR}/wodles/aws/buckets_s3/vpcflow.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/buckets_s3/waf.py ${INSTALLDIR}/wodles/aws/buckets_s3/waf.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/services/aws_service.py ${INSTALLDIR}/wodles/aws/services/aws_service.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/services/cloudwatchlogs.py ${INSTALLDIR}/wodles/aws/services/cloudwatchlogs.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/services/__init__.py ${INSTALLDIR}/wodles/aws/services/__init__.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/services/inspector.py ${INSTALLDIR}/wodles/aws/services/inspector.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/subscribers/__init__.py ${INSTALLDIR}/wodles/aws/subscribers/__init__.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/subscribers/sqs_queue.py ${INSTALLDIR}/wodles/aws/subscribers/sqs_queue.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/subscribers/s3_log_handler.py ${INSTALLDIR}/wodles/aws/subscribers/s3_log_handler.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/aws/subscribers/sqs_message_processor.py ${INSTALLDIR}/wodles/aws/subscribers/sqs_message_processor.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../framework/wrappers/generic_wrapper.sh ${INSTALLDIR}/wodles/aws/aws-s3

    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/gcloud
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/gcloud/buckets
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/gcloud/pubsub
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/gcloud.py ${INSTALLDIR}/wodles/gcloud/gcloud.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/integration.py ${INSTALLDIR}/wodles/gcloud/integration.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/tools.py ${INSTALLDIR}/wodles/gcloud/tools.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/exceptions.py ${INSTALLDIR}/wodles/gcloud/exceptions.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/buckets/bucket.py ${INSTALLDIR}/wodles/gcloud/buckets/bucket.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/buckets/access_logs.py ${INSTALLDIR}/wodles/gcloud/buckets/access_logs.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/pubsub/subscriber.py ${INSTALLDIR}/wodles/gcloud/pubsub/subscriber.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../framework/wrappers/generic_wrapper.sh ${INSTALLDIR}/wodles/gcloud/gcloud

    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/docker
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/docker-listener/DockerListener.py ${INSTALLDIR}/wodles/docker/DockerListener.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../framework/wrappers/generic_wrapper.sh ${INSTALLDIR}/wodles/docker/DockerListener

    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/azure
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/azure/azure-logs.py ${INSTALLDIR}/wodles/azure/azure-logs.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../framework/wrappers/generic_wrapper.sh ${INSTALLDIR}/wodles/azure/azure-logs
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/azure/orm.py ${INSTALLDIR}/wodles/azure/orm.py

    GenerateAuthCert

    # Add the wrappers for python script in active-response
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../framework/wrappers/generic_wrapper.sh ${INSTALLDIR}/integrations/pagerduty
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../framework/wrappers/generic_wrapper.sh ${INSTALLDIR}/integrations/slack
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../framework/wrappers/generic_wrapper.sh ${INSTALLDIR}/integrations/virustotal
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../framework/wrappers/generic_wrapper.sh ${INSTALLDIR}/integrations/shuffle
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../framework/wrappers/generic_wrapper.sh ${INSTALLDIR}/integrations/maltiverse

    # Keystore
    ${INSTALL} -d -m 0750 -o ${FORTISHIELD_USER} -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/queue/keystore
...
InstallAgent()
{
    ...
    ${INSTALL} -d -m 0770 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/var/incoming
    ${INSTALL} -m 0660 -o root -g ${FORTISHIELD_GROUP} ../ruleset/rootcheck/db/*.txt ${INSTALLDIR}/etc/shared/
    ${INSTALL} -m 0640 -o root -g ${FORTISHIELD_GROUP} ../etc/wpk_root.pem ${INSTALLDIR}/etc/
    ...
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/gcloud/pubsub
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/gcloud/buckets
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/gcloud.py ${INSTALLDIR}/wodles/gcloud/gcloud
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/integration.py ${INSTALLDIR}/wodles/gcloud/integration.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/tools.py ${INSTALLDIR}/wodles/gcloud/tools.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/exceptions.py ${INSTALLDIR}/wodles/gcloud/exceptions.py
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/gcloud/buckets/bucket.py ${INSTALLDIR}/wodles/gcloud/buckets/bucket.py
    ...
    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/docker
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/docker-listener/DockerListener.py ${INSTALLDIR}/wodles/docker/DockerListener

    ${INSTALL} -d -m 0750 -o root -g ${FORTISHIELD_GROUP} ${INSTALLDIR}/wodles/azure
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/azure/azure-logs.py ${INSTALLDIR}/wodles/azure/azure-logs
    ${INSTALL} -m 0750 -o root -g ${FORTISHIELD_GROUP} ../wodles/azure/orm.py ${INSTALLDIR}/wodles/azure/orm.py
}
