...
# Install functions for Fortishield
# fortishield.khulnasoft.com (https://github.com/fortishield)
...
FortishieldUpgrade()
{
    ...
    # Remove existing SQLite databases for Fortishield DB, only if upgrading from 3.2..3.6
    ...
    # Remove deprecated Fortishield tools
    ...
    # Remove old Fortishield daemons
