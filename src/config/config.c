                              ...
                              void *d2)
{
    ...
    const char *oswmodule = "wodle";                            /* Wodle - Fortishield Module  */
    ...
    const char *osgcp_pub = "gcp-pubsub";                       /* Google Cloud PubSub - Fortishield Module */
    const char *osgcp_bucket = "gcp-bucket";                    /* Google Cloud Bucket - Fortishield Module */
        ...
        if (chld_node && (strcmp(node[i]->element, osglobal) == 0)) {
            ...
            if ((modules & CWMODULE)) {
                mwarn(
                    ...
                    "the new '%s' block for continued vulnerability management. See https://fortishield.github.io/documentation",
                    osvulndetector,
                    osvulndetection);
