...
from fortishield.core.cluster import __version__
from fortishield.core.common import MAX_SOCKET_BUFFER_SIZE, AGENT_NAME_LEN_LIMIT, MAX_GROUPS_PER_MULTIGROUP

GENERIC_ERROR_MSG = "Fortishield Internal Error. See log for more detail"
DOCU_VERSION = 'current' if __version__ == '' else '.'.join(__version__.split('.')[:2]).lstrip('v')

class FortishieldException(Exception):
    """
    Fortishield Exception object.
    """

    ERRORS = {
        # < 999: API
        900: 'One of the API child processes terminated abruptly. The API process pool is not usable anymore. '
             'Please restart the Fortishield API',
        901: 'API executor subprocess broke. A service restart may be needed',
        902: 'API Endpoint only available on master node',

        # Fortishield: 0999 - 1099
        999: 'Incompatible version of Python',
        1000: {'message': 'Fortishield Internal Error',
               'remediation': 'Please, check `FORTISHIELD_HOME/logs/ossec.log`, `FORTISHIELD_HOME/logs/cluster.log` and '
                              '`FORTISHIELD_HOME/logs/api.log` to get more information about the error'},
        ...
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in Fortishield directories'},
        1006: {'message': 'File/directory does not exist or there is a problem with the permissions',
               'remediation': 'Please, check if path to file/directory is correct and `fortishield` '
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart Fortishield to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in Fortishield directories'},
        1017: 'Some Fortishield daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        1018: 'Body request is not a valid JSON',
        1019: 'Error trying to create backup file',
        1020: {'message': 'Could not find any Fortishield log file',
               'remediation': 'Please check `FORTISHIELD_HOME/logs`'},
        ...
        1102: {'message': 'Invalid section',
               'remediation': f'Please, visit the official documentation (https://fortishield.github.io/documentation/'
        ...
        1106: {'message': 'Requested section not present in configuration',
               'remediation': 'Please, check your configuration file. '
                              f'You can visit the official documentation (https://fortishield.github.io/documentation/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html) '
                              'to get more information about configuration sections'},
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'fortishield' user",
        ...
        1122: {'message': 'Experimental features are disabled',
               'remediation': 'Experimental features can be enabled in FORTISHIELD_PATH/api/configuration/api.yaml or '
                              f"using API endpoint https://fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/api/"
                              'reference.html#operation/api.controllers.manager_controller.put_api_config or '
                              f"https://fortishield.github.io/documentation/{DOCU_VERSION}/"
        ...
        1124: {'message': 'Remote command detected',
               'remediation': f'To solve this issue, please enable the remote commands in the API settings or add an '
                              f'exception: https://fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/api/'
        ...
        1126: {'message': 'Error updating ossec configuration',
               'remediation': 'Please, ensure `FORTISHIELD_PATH/etc/ossec.conf` has the proper permissions and ownership.'
               },
        1127: {'message': 'Protected section was modified',
               'remediation': 'To solve this, either revert the changes made to this section or disable the protection '
                              'in the API settings: '
                              f"https://fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/api/configuration.html"},
        ...
        1129: {'message': 'Higher version agents detected',
               'remediation': f'To solve this issue, please enable agents higher versions in the API settings: '
                              f'https://fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/api/'
        ...
        1209: {'message': 'Invalid relative directory. A \'rule_dir\' tag must '
               ...
               'remediation': f'Please, visit the official documentation '
                              f'(https://fortishield.github.io/documentation/'
        ...
        1211: {'message': 'Invalid relative directory. A \'rule_dir\' tag is declared in ossec.conf '
               ...
               'remediation': f'Please, visit the official documentation'
                               '(https://fortishield.github.io/documentation/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/ruleset.html)'
                              ' to get more information about the rules'
               },
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, '
                              'contact us at [official repository](https://github.com/fortishield/fortishield/issues)'
               },
        ...
        1707: {'message': 'Cannot send request, agent is not active',
               'remediation': 'Please, check non-active agents connection and try again. Visit '
                              f'https://fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/registering/index.html and '
                              f'https://fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/agents/agent-connection.'
        ...
        1726: {'message': 'Fortishield authd is not running',
        ...
        1728: {'message': 'Invalid node type',
               'remediation': f'Valid types are `master` and `worker`. Please, visit https://fortishield.github.io/documentation/'
        ...
        1730: {'message': 'Node does not exist',
               'remediation': 'Make sure the name is correct and that the node is up. You can check it using '
                              f'`cluster_control -l` (https://fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/'
        ...
        1734: {'message': 'Error removing agent from group',
               'remediation': f'Agent does not belong to specified group, to assign the agent to a group follow: '
                              f'https://fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/agents/grouping-agents.html'
               },
        1735: {'message': 'Agent version is not compatible with this feature',
               'remediation': 'Please update the agent, in case the problem persists contact us at: https://github.com'
                              '/fortishield/fortishield/issues'
               },
        ...
        1743: 'Error running Fortishield syntax validator',
        ...
        1750: {'message': 'Could not send restart command, active-response is disabled in the agent',
               'remediation': "You can activate it in agents' `FORTISHIELD_HOME/etc/ossec.conf`"},
        ...
        2003: {'message': 'Error in fortishielddb request',
               'remediation': 'Make sure the request is correct'},
        2004: {'message': 'Database query not valid'},
        2005: {'message': 'Could not connect to fdb socket'},
        2006: {'message': 'Received JSON from Fortishield DB is not correctly formatted'},
        2007: {'message': 'Error retrieving data from Fortishield DB'},
        2008: {'message': 'Corrupted RBAC database',
               'remediation': 'Restart the Fortishield service to restore the RBAC database to default'},
        2009: {'message': 'Pagination error. Response from fortishield-db was over the maximum socket buffer size'},
        ...
        3019: 'Fortishield is running in cluster mode: {EXECUTABLE_NAME} is not available in worker nodes. Please, '
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at FORTISHIELD_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `fortishield-manager` service.'},
        ...
        3025: {'message': "Could not decrypt message",
               'remediation': "Check the cluster key is correct in the worker's "
                              f"[ossec.conf](https://fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/reference/"
        ...
        3028: {'message': "Worker node ID already exists",
               'remediation': f"Check and fix [worker names](https://fortishield.github.io/documentation/{DOCU_VERSION}/"
        ...
        3029: {"message": "Connected worker with same name as the master",
               "remediation": f"Check and fix the [worker name](https://fortishield.github.io/documentation/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `fortishield-manager` service in the node"},
        3030: {'message': 'Worker does not belong to the same cluster',
               'remediation': f"Change the [cluster name](https://fortishield.github.io/documentation/{DOCU_VERSION}/"
        ...
        3031: {'message': "Worker and master versions are not the same",
               'remediation': f"[Update](https://fortishield.github.io/documentation/{DOCU_VERSION}/upgrade-guide/index.html)"
        ...
        4008: {'message': 'The specified resource is required for a correct Fortishield\'s functionality'},
        ...
        4019: {'message': 'Invalid resource specified',
               'remediation': f'Please, check the current RBAC resources, for more information please visit https:/'
                              f'/fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/api/rbac/configuration.html'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (fortishield) or '
        ...
        6001: {'message': 'Maximum number of requests per minute reached',
               'remediation': f'This limit can be changed in api.yaml file. More information here: https:/'
                              f'/fortishield.github.io/documentation/{DOCU_VERSION}/user-manual/api/configuration.html#'
        ...
        6004: {'message': 'The current user does not have authentication enabled through authorization context',
               'remediation': f'You can enable it using the following endpoint: https://fortishield.github.io/documentation/'
                              f'{DOCU_VERSION}/user-manual/api/reference.html#operation/api.controllers.'
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
        ...
        """Create a FortishieldException object.
        ...
        dapi_errors : dict
            Dictionary with details about node and logfile. I.e.: {'master-node': {'error': 'Fortishield Internal error',
            'logfile': FORTISHIELD_HOME/logs/api.log}}
        title : str
    ...
    def __eq__(self, other):
        if not isinstance(other, FortishieldException):
    ...
    def __or__(self, other):
        if isinstance(other, FortishieldException):
...
class FortishieldInternalError(FortishieldException):
    """
    ...
    _default_title = "Fortishield Internal Error"

    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a FortishieldInternalError exception.
...
class FortishieldClusterError(FortishieldInternalError):
    """
    This type of exception is raised inside the cluster.
    """
    _default_type = "about:blank"
    _default_title = "Fortishield Cluster Error"


class FortishieldError(FortishieldException):
    """
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a FortishieldError exception.
    ...
    def __or__(self, other):
        result: FortishieldError = super().__or__(other)
        if isinstance(result, FortishieldError):
...
class FortishieldPermissionError(FortishieldError):
    """
...
class FortishieldResourceNotFound(FortishieldError):
    """
...
class FortishieldTooManyRequests(FortishieldError):
    """
...
class FortishieldNotAcceptable(FortishieldError):
    """
